"""
Calculate baseline surprisal values using GPT-2 model.
This serves as a baseline for comparing different tokenization methods.
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('baseline_surprisal.log'),
        logging.StreamHandler()
    ]
)

class BaselineSurprisalCalculator:
    def __init__(self, model_name: str = "gpt2"):
        """Initialize the calculator with GPT-2 model and tokenizer."""
...
def save_results(results: Dict[str, Any], output_dir: str = "results"):
    ...
    output_file = output_dir / "baseline_surprisal_results.json"
...
def main():
    ...
    calculator = BaselineSurprisalCalculator()
